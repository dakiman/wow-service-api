 ...
 * Generated for Laravel 5.6.39 on 2018-10-15 12:26:54.
 *
...
namespace Illuminate\Support\Facades { 
    ...
    class Response {
         ...
         * @static 
         */ 
        public static function api($data = array(), $statusCode = 500, $errors = array())
        {
            return \Illuminate\Routing\ResponseFactory::api($data, $statusCode, $errors);
        }
